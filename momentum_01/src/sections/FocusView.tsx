...
export default function FocusView() {
  ...
  return (
    <div className="w-full h-full relative flex flex-col px-4 pt-4 items-center justify-center z-0">
      ...
      <div className="absolute top-6 left-6 text-4xl font-light">Focus</div>

      {/*Timer Display */}
      <div className="flex gap-6 mt-20 items-end">
        {/* Hours */}
        <div className="flex flex-col items-center">
          <div className="text-7xl font tracking-widest">{format(hrs)}</div>
        ...
        {/* Minutes */}
        <div className="flex flex-col items-center">
          <div className="text-7xl font tracking-widest">{format(mins)}</div>
        ...
        {/* Seconds */}
        <div className="flex flex-col items-center">
          <div className="text-7xl font tracking-widest">{format(secs)}</div>
      ...
      {/* Tag Selection -- need to replace it with CategoryPill component */}
        ...
        {selectedTag ? (
            ...
            {tagOptions.map((tag) => (
                ...
                className="bg-white text-black border border-gray-300 hover:bg-gray-100 px-3 py-1 rounded-full text-sm transition cursor-pointer"
                >
                {tag}
                </button>
            ))}
